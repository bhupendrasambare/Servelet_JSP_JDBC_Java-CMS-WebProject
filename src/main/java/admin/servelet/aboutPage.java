...
import controller.admin.EditPages;
import controller.admin.allProduct;

/**
 * Servlet implementation class aboutPage
 */
@MultipartConfig
...
//		response.getWriter().append("Served at: ").append(request.getContextPath());
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	...
    	EditPages inputPage = new EditPages();
		...
		if(uploadFile(is,path,part,fos)){
		    inputPage.setPage(page,filename, info);
		    doGet(request, response);
		}		
		
		response.getWriter().append("Served at:page- "+page);
	}
